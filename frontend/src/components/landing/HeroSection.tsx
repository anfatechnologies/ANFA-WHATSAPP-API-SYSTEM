      ...
      <div className="container mx-auto px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a href="#" className="px-8 py-4 rounded-xl bg-primary-600 hover:bg-primary-500 text-white font-semibold transition-all transform hover:scale-105 hover:shadow-[0_0_20px_rgba(16,185,129,0.4)]">
              View on GitHub
            </a>
            <a href="#" className="px-8 py-4 rounded-xl bg-slate-900/60 backdrop-blur border border-slate-700 hover:border-slate-500 text-slate-200 font-semibold transition-all hover:bg-slate-800/80">
